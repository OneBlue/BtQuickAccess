...
I much prefered the one click UI, so I created this app, which restores the Android < 14 behavior.

The tile is designed to look and behave exactly like the system bluetooth tile.
